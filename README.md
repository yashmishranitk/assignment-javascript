...
This section of the tutorial will be helpful for those who run their website on HiFi CMS. It's a nice platform with an amazing JSON based API and many exciting features to ensure pleasurable user experience. Here is my HiFi query:
